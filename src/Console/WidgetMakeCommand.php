...
namespace Brunolobo\Widgets\Console;
...
class WidgetMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Cria um novo widget (brunolobo/widgets)';
    ...
    protected function getStub()
    {
        ...
        $stubPath = $this->laravel->make('config')->get('pacto-widgets.'.$stubName.'_stub');
    ...
    {
        $namespace = config('pacto-widgets.default_namespace', $rootNamespace.'\Widgets');
