...
use Brunolobo\Widgets\Test\Dummies\TestCachedWidget;
...
class WidgetFactoryTest extends TestCase
{
    ...
    {
        $this->setExpectedException('\Brunolobo\Widgets\Misc\InvalidWidgetClassException');
    ...
    {
        $output = $this->factory->run('\Brunolobo\Widgets\Test\Dummies\TestDefaultSlider');
    ...
    public function testItCanRunReloadableWidgets()
    {
        ...
        $this->assertEquals(
            '<div id="brunolobo-widget-container-1" style="display:inline" class="brunolobo-widget-container">Feed was executed with $slides = 6'.
                '<script type="text/javascript">'.
                    'setTimeout( function() {'.
                        'var widgetTimer1 = setInterval(function() {'.
                            'if (window.$) {'.
                                "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('TestRepeatableFeed')."');".
    ...
    public function testWidgetContainerCanBeCustomized()
    {
        ...
        $this->assertEquals(
            '<p id="brunolobo-widget-container-1" data-id="123">Dummy Content'.
                '<script type="text/javascript">'.
                    'setTimeout( function() {'.
                        'var widgetTimer1 = setInterval(function() {'.
                            'if (window.$) {'.
                                "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('TestWidgetWithCustomContainer')."');".
                                'clearInterval(widgetTimer1);'.
                            '}'.
                        '}, 100);'.
                    '}, 10000)'.
    ...
    public function testItCanCacheWidgets()
    {
        ...
        $key = 'brunolobo.widgets.'.serialize(['testCachedWidget', ['foo' => 'bar']]);
