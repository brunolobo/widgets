...
class JavascriptFactory
{
     ...
     * @var string
     */
    protected $ajaxLink = '/brunolobo/load-widget';
    ...
    {
        return 'brunolobo-widget-container-'.WidgetId::get();
    }
    ...
    {
        return $this->widgetFactory->app->config('pacto-widgets.use_jquery_for_ajax_calls', false);
    }
