...
class AsyncWidgetFactoryTest extends TestCase
{
    ...
    public function testItCanRunAsyncWidget()
    {
        ...
        $expected =
            '<div id="brunolobo-widget-container-1" style="display:inline" class="brunolobo-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('TestDefaultSlider')."');".
    ...
    public function testItCanRunAsyncWidgetWithPlaceholder()
    {
        ...
        $expected =
            '<div id="brunolobo-widget-container-1" style="display:inline" class="brunolobo-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('Slider')."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
    ...
    public function testItCanRunMultipleAsyncWidgets()
    {
        ...
        $expected =
            '<div id="brunolobo-widget-container-2" style="display:inline" class="brunolobo-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer2 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#brunolobo-widget-container-2').load('".$this->ajaxUrl('TestDefaultSlider', [], 2)."');".
        ...
        $expected =
            '<div id="brunolobo-widget-container-1" style="display:inline" class="brunolobo-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('TestWidgetWithParamsInRun', $params)."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
        ...
        $expected =
            '<div id="brunolobo-widget-container-1" style="display:inline" class="brunolobo-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#brunolobo-widget-container-1').load('".$this->ajaxUrl('Profile\TestNamespace\TestFeed')."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
    ...
    {
        $this->factory->app->config['pacto-widgets.use_jquery_for_ajax_calls'] = false;
                    ...
                    'setTimeout(function() {'.
                        ...
                        'xhr.onreadystatechange = function() {'.
                            'if(xhr.readyState == 4 && xhr.status == 200) {'.
                                'var container = document.getElementById("brunolobo-widget-container-1");'.
